  ...
  document.getElementById("my-figure14").addEventListener("click", function(){
    var figure = document.getElementById("my-figure14");
    var img = document.getElementById("my-image14");
    var caption = document.getElementById("my-caption14");
    if(!originalWidth){
  ...
  document.getElementById("my-figure14").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure14");
	var img = document.getElementById("my-image14");
    var caption = document.getElementById("my-caption14");
