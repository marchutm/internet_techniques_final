  ...
  document.getElementById("my-figure21").addEventListener("click", function(){
    var figure = document.getElementById("my-figure21");
    var img = document.getElementById("my-image21");
    var caption = document.getElementById("my-caption21");
    if(!originalWidth){
  ...
  document.getElementById("my-figure21").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure21");
	var img = document.getElementById("my-image21");
    var caption = document.getElementById("my-caption21");
