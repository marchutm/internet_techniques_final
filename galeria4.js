  ...
  document.getElementById("my-figure4").addEventListener("click", function(){
    var figure = document.getElementById("my-figure4");
    var img = document.getElementById("my-image4");
    var caption = document.getElementById("my-caption4");
    if(!originalWidth){
  ...
  document.getElementById("my-figure4").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure4");
	var img = document.getElementById("my-image4");
    var caption = document.getElementById("my-caption4");
