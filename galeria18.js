  ...
  document.getElementById("my-figure18").addEventListener("click", function(){
    var figure = document.getElementById("my-figure18");
    var img = document.getElementById("my-image18");
    var caption = document.getElementById("my-caption18");
    if(!originalWidth){
  ...
  document.getElementById("my-figure18").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure18");
	var img = document.getElementById("my-image18");
    var caption = document.getElementById("my-caption18");
