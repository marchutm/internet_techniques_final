  ...
  document.getElementById("my-figure23").addEventListener("click", function(){
    var figure = document.getElementById("my-figure23");
    var img = document.getElementById("my-image23");
    var caption = document.getElementById("my-caption23");
    if(!originalWidth){
  ...
  document.getElementById("my-figure23").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure23");
	var img = document.getElementById("my-image23");
    var caption = document.getElementById("my-caption23");
