  ...
  document.getElementById("my-figure13").addEventListener("click", function(){
    var figure = document.getElementById("my-figure13");
    var img = document.getElementById("my-image13");
    var caption = document.getElementById("my-caption13");
    if(!originalWidth){
  ...
  document.getElementById("my-figure13").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure13");
	var img = document.getElementById("my-image13");
    var caption = document.getElementById("my-caption13");
