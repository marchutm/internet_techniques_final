  ...
  document.getElementById("my-figure8").addEventListener("click", function(){
    var figure = document.getElementById("my-figure8");
    var img = document.getElementById("my-image8");
    var caption = document.getElementById("my-caption8");
    if(!originalWidth){
  ...
  document.getElementById("my-figure8").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure8");
	var img = document.getElementById("my-image8");
    var caption = document.getElementById("my-caption8");
