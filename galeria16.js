  ...
  document.getElementById("my-figure16").addEventListener("click", function(){
    var figure = document.getElementById("my-figure16");
    var img = document.getElementById("my-image16");
    var caption = document.getElementById("my-caption16");
    if(!originalWidth){
  ...
  document.getElementById("my-figure16").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure16");
	var img = document.getElementById("my-image16");
    var caption = document.getElementById("my-caption16");
