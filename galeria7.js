  ...
  document.getElementById("my-figure7").addEventListener("click", function(){
    var figure = document.getElementById("my-figure7");
    var img = document.getElementById("my-image7");
    var caption = document.getElementById("my-caption7");
    if(!originalWidth){
  ...
  document.getElementById("my-figure7").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure7");
	var img = document.getElementById("my-image7");
    var caption = document.getElementById("my-caption7");
