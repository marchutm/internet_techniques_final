...
const images = [
    {src: 'img/sniezka/image1.jpg', caption: 'Szczyt Śnieżki'},
    {src: 'img/sniezka/image2.jpg', caption: 'Widok na Snieżkę z trasy'},
	{src: 'img/sniezka/image3.jpg', caption: 'Schronisko Jelenka'}
];
let currentIndex = 0;
