  ...
  document.getElementById("my-figure24").addEventListener("click", function(){
    var figure = document.getElementById("my-figure24");
    var img = document.getElementById("my-image24");
    var caption = document.getElementById("my-caption24");
    if(!originalWidth){
  ...
  document.getElementById("my-figure24").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure24");
	var img = document.getElementById("my-image24");
    var caption = document.getElementById("my-caption24");
