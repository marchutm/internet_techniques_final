  ...
  document.getElementById("my-figure11").addEventListener("click", function(){
    var figure = document.getElementById("my-figure11");
    var img = document.getElementById("my-image11");
    var caption = document.getElementById("my-caption11");
    if(!originalWidth){
  ...
  document.getElementById("my-figure11").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure11");
	var img = document.getElementById("my-image11");
    var caption = document.getElementById("my-caption11");
