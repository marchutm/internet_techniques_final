  ...
  document.getElementById("my-figure12").addEventListener("click", function(){
    var figure = document.getElementById("my-figure12");
    var img = document.getElementById("my-image12");
    var caption = document.getElementById("my-caption12");
    if(!originalWidth){
  ...
  document.getElementById("my-figure12").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure12");
	var img = document.getElementById("my-image12");
    var caption = document.getElementById("my-caption12");
