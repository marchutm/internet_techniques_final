  ...
  document.getElementById("my-figure17").addEventListener("click", function(){
    var figure = document.getElementById("my-figure17");
    var img = document.getElementById("my-image17");
    var caption = document.getElementById("my-caption17");
    if(!originalWidth){
  ...
  document.getElementById("my-figure17").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure17");
	var img = document.getElementById("my-image17");
    var caption = document.getElementById("my-caption17");
