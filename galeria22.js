  ...
  document.getElementById("my-figure22").addEventListener("click", function(){
    var figure = document.getElementById("my-figure22");
    var img = document.getElementById("my-image22");
    var caption = document.getElementById("my-caption22");
    if(!originalWidth){
  ...
  document.getElementById("my-figure22").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure22");
	var img = document.getElementById("my-image22");
    var caption = document.getElementById("my-caption22");
