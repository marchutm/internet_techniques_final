  ...
  document.getElementById("my-figure20").addEventListener("click", function(){
    var figure = document.getElementById("my-figure20");
    var img = document.getElementById("my-image20");
    var caption = document.getElementById("my-caption20");
    if(!originalWidth){
  ...
  document.getElementById("my-figure20").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure20");
	var img = document.getElementById("my-image20");
    var caption = document.getElementById("my-caption20");
