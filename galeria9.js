  ...
  document.getElementById("my-figure9").addEventListener("click", function(){
    var figure = document.getElementById("my-figure9");
    var img = document.getElementById("my-image9");
    var caption = document.getElementById("my-caption9");
    if(!originalWidth){
  ...
  document.getElementById("my-figure9").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure9");
	var img = document.getElementById("my-image9");
    var caption = document.getElementById("my-caption9");
