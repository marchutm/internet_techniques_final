  ...
  document.getElementById("my-figure10").addEventListener("click", function(){
    var figure = document.getElementById("my-figure10");
    var img = document.getElementById("my-image10");
    var caption = document.getElementById("my-caption10");
    if(!originalWidth){
  ...
  document.getElementById("my-figure10").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure10");
	var img = document.getElementById("my-image10");
    var caption = document.getElementById("my-caption10");
