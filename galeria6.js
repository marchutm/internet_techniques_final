  ...
  document.getElementById("my-figure6").addEventListener("click", function(){
    var figure = document.getElementById("my-figure6");
    var img = document.getElementById("my-image6");
    var caption = document.getElementById("my-caption6");
    if(!originalWidth){
  ...
  document.getElementById("my-figure6").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure6");
	var img = document.getElementById("my-image6");
    var caption = document.getElementById("my-caption6");
