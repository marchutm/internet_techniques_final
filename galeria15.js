  ...
  document.getElementById("my-figure15").addEventListener("click", function(){
    var figure = document.getElementById("my-figure15");
    var img = document.getElementById("my-image15");
    var caption = document.getElementById("my-caption15");
    if(!originalWidth){
  ...
  document.getElementById("my-figure15").addEventListener("mouseout", function(){
    var figure = document.getElementById("my-figure15");
	var img = document.getElementById("my-image15");
    var caption = document.getElementById("my-caption15");
